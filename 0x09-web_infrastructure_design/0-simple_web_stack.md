...
This is a simple web infrastructure that hosts a website that is reachable via `www.foobar.com`. It is a simple configuration with no protection such as firewalls, SSL (Secure Socket Layer) and TLS (Transport Layer Security). 
